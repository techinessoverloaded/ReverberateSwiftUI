...
public class User: NSManagedObject {
    ...
    public var playlists: [Playlist]?
    {
        get
        {
            ...
            for key in decodedPlaylistsData.keys
            {
                ...
                {
                    let song = DataProcessor.getSong(named: songName)!
    ...
    public var favouriteSongs: [Song]?
    {
        get
        {
            ...
            {
                result.append(DataProcessor.getSong(named: songName)!)
            }
            return result
        }
    }
    ...
    public var favouriteAlbums: [Album]?
    {
        get
        {
            ...
            {
                result.append(DataProcessor.getAlbum(named: albumName)!)
            }
            return result
        }
    }
    ...
    public var favouriteArtists: [Artist]?
    {
        get
        {
            ...
            {
                result.append(DataProcessor.getArtist(named: artistName)!)
            }
            return result
        }
    }
